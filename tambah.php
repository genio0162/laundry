...
<?php
    if(isset($_POST["submit"])){
        ...
        $harga = $_POST["total"];
        $fum = $_POST["parfum"];
        $query = "INSERT INTO tb_pelanggan VALUES ('','$nama','$berat','$harga','$fum','','$tgl_terima','$tgl_kembali','$jumlah')";
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
                <div class="form-group">
                    ...
                    <input name = "nama" type="text" class="form-control" id="nama" placeholder="Masukkan Nama"><br>
                    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                    <label for="Berat">Berat</label>
                    <input name = "berat"type="text" class="form-control" id="Berat" placeholder="Masukkan Berat (kg)"><br>
                    <label for="Jumlah Pakaian">Jumlah Pakaian</label>
                    <input name = "jumlah"type="text" class="form-control" id="Jumlah Pakaian" placeholder="Masukkan Jumlah Pakaian"><br>
                    <label for="Tanggal_Terima">Tanggal Terima</label>
                    <input name="tgl_terima"type="date" class="form-control" id="Tanggal_Terima" placeholder="Masukkan Tanggal Terima"><br>
                    <label for="Tanggal_Kembali">Tanggal Kembali</label>
                    <input name="tgl_kembali" type="date" class="form-control" id="Tanggal_Kembali" placeholder="Masukkan Tanggal Kembali"><br>
